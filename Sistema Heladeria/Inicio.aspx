...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-4"> 
        ...
        <center style="width: 200px">
                            ...
                            <div class="image-button-container" style="width: 195px">
                                <img alt="Imagen" src="imagenes 2-0/historial.jpg" width="150" height="150"/>
                            </div>
                                </a>
                        </center>
        <center>
                            <asp:Label ID="Label7" runat="server" CssClass="btn btn-primary" Text="Resumenes" width="150"></asp:Label>
                     </center>       
    </div>
        </div>
    </center>
