      ...
      <div class="modal-body">
        ...
        <tr>
            ...
            <%--<td style="height: 22px; width: 646px">
                    <asp:DropDownList ID="Categorias_list" runat="server" DataSourceID="SqlDataSource1" DataTextField="Nombre_categoria" DataValueField="Nombre_categoria" Height="16px" Width="127px" style="font-size: 14pt">
                    </asp:DropDownList>
